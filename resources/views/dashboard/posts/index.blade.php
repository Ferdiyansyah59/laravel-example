...
<div class="table-responsive">
  <a class="btn btn-primary mb-3" href="/dashboard/posts/create"><span data-feather="plus"></span> Create new post</a>
          ...
          <tr>
            ...
            <td>
                ...
                <form class="d-inline" action="/dashboard/posts/{{ $posts->slug }}" method="POST">
                   @method('delete')
                   @csrf
                   <button class="badge bg-danger border-0" onclick="return confirm('Aare you sure?')"><span data-feather="x-circle"></span></button>
                </form>
            </td>
          </tr>
          @endforeach
